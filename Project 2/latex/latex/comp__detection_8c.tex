\section{comp\-\_\-detection.\-c File Reference}
\label{comp__detection_8c}\index{comp\-\_\-detection.\-c@{comp\-\_\-detection.\-c}}
...
Creates two threads one to send and one to receive. Also checks to the number of comman line arguments. If there is less then 8 the program will give a warning then exit. After spawning the threads it waits for them to finish before exiting. before freeing up memory. \index{comp\-\_\-detection.\-c@{comp\-\_\-detection.\-c}!rec\-Packets@{rec\-Packets}}
...
A raw socket is opened and receives all the icmp packets. All the repleys are time stamp. After all the packets have been received the R\-T\-T is calculated. \index{comp\-\_\-detection.\-c@{comp\-\_\-detection.\-c}!send\-I\-C\-M\-P@{send\-I\-C\-M\-P}}
...
Sends a I\-C\-M\-P message to dest using the socket pass to it. Also records the time after sending every packet. \index{comp\-\_\-detection.\-c@{comp\-\_\-detection.\-c}!send\-Packets@{send\-Packets}}
...
Opens a raw socket which is used to send udp/icmp packets. Runs on its own thread and is called from the main. Sends all the necessary packets. \index{comp\-\_\-detection.\-c@{comp\-\_\-detection.\-c}!send\-Udp\-Train@{send\-Udp\-Train}}
